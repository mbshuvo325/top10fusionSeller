...
class _NewWholeSaleProductState extends State<NewWholeSaleProduct> {
  ...
  TextEditingController weightEditTextController =  TextEditingController(text: "0.0");
  TextEditingController minimumEditTextController = TextEditingController(text: "1");
  ...
  TextEditingController metaDescriptionEditTextController = TextEditingController();
  ...
  GlobalKey<FlutterSummernoteState> productDescriptionKey = GlobalKey<FlutterSummernoteState>();
...
List  getPrices() {
  ...
  submitProduct(String button) async {
    ...
    var response = await ProductRepository().addWholeSaleProductResponse(postBody);
          ...
          Container(
              ...
              child: Buttons(
                ...
                submitProduct("publish");
                 ...
                 child: Text(LangText(context: context).getLocal()!.save_n_publish_ucf,
                      style: TextStyle(color: MyTheme.white))))
        ],
      ),
    );
        ...
        children: [
         // SizedBox(height:80,),
                  ...
                  (index) => Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            child:  Icon(Icons.cancel,color: MyTheme.red,),
          ...
          Buttons(
                  onPressed:
              () {
            minQTYTextEditTextController.add(TextEditingController(text: "0"));
            maxQTYTextEditTextController.add(TextEditingController(text: "0"));
            priceTextEditTextController.add(TextEditingController(text: "1"));
            setChange();
          },
              color: MyTheme.textfield_grey,
